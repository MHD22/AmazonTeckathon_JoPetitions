...
class Petition extends Component{
    ...
    render(){
        const {title,firstName,lastName,text,supports,photo}= this.props.data;
        const name= firstName+" "+lastName;
        const {route}=this.props;
        const data2= {title,name,text,supports,photo,route};
        return(
            <article onClick={()=>{this.props.readPetition(data2)}}
             class="pointer dim  ph2 br3 shadow-3 bt bb b--black-10 bg-black-10 mb4 mt4">
                ...
                <div class="row flex-row-ns">
                    ...
                    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-people-fill green p3 mh2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
